let first1 = [document.querySelector('#date'), document.querySelector('#haur'),document.querySelector("#description"),document.querySelector("#alerts")];
...
let second1 = [document.querySelector('#city'), document.querySelector('#temp')];
