...
function thisWeek(resultFromServer) {
    ...
    day1Icon.src = 'http://openweathermap.org/img/wn/' + resultFromServer.day1icon + '.png';
    ...
    day2Icon.src = 'http://openweathermap.org/img/wn/' + resultFromServer.day2icon + '.png';
    ...
    day3Icon.src = 'http://openweathermap.org/img/wn/' + resultFromServer.day3icon + '.png';
    ...
    day4Icon.src = 'http://openweathermap.org/img/wn/' + resultFromServer.day4icon + '.png';
